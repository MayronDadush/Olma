...
const RATES = {
  ...
  // flash is ordered to StreamLake first (scripts/pin-openrouter-provider.js,
  // re-cut 2026-09-14), so these are THAT provider's rates from OpenRouter's
  // /models/deepseek/deepseek-v4-flash/endpoints on the day. Before that it
  // was DigitalOcean at 0.068 (2026-09-09), and before that the unpinned
  // blend 0.08092 / 0.16184 / 0.016184. Rows already in the ledger keep the
  // rate they were written with; a call that falls back to Novita (0.14) is
  // priced under truth here.
  'deepseek/deepseek-v4-flash': { input: 0.084, output: 0.168, cacheWrite: 0.084, cacheRead: 0.0168 },
