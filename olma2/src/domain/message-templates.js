...
const TEMPLATES = [
  ...
  // paragraphs.
  {
    ...
    help: 'פעם אחת, ברגע שנפתח תיאום בקבוצה: אומרת שהיא מתחילה, וסופרת את כל חברי הקבוצה. מי שעוד לא כתב לה בפרטי מתויג בהערה, רק כשיש כאלה.',
    vars: {
      title: 'מה מתארגן, במילים של הקבוצה',
      total: 'כמה אנשים בקבוצה (כולם, גם מי שעוד לא כתב לה)',
      outside_note: 'הערה על מי שעוד לא כתב לה — רק כשיש כאלה בקבוצה',
    },
    required: ['title', 'total'],
    sample: {
      title: 'פאדל השבוע', total: '6',
      outside_note: '@+972501234567 עוד לא כתבת לי בפרטי — ״היי״ שם ואצרף אותך לתיאום ☺️',
    },
    text: 'מתחילה לתאם *{{title}}* לכל {{total}} חברי הקבוצה 🎯\nשואלת כל אחד בפרטי, ואחזור לכאן עם מה שמסתדר.\n{{outside_note}}',
  },
  ...
  },
  {
    ...
    help: 'פעם אחת בכל תיאום, ברגע שיש זמן שכמה אנשים אמרו לו כן (או שהגיע למינימום, בקבוצת משחק) ועוד לא כל הקבוצה אמרה כן. סופרת את כל חברי הקבוצה, ומציעה לסגור בלי מי שלא ענה — התיאום נסגר לבד רק כשכל הקבוצה אמרה כן.',
    vars: {
      slot: 'הזמן שמוביל', yes: 'כמה אמרו לו כן', total: 'כמה אנשים בקבוצה',
      close_note: 'מי עוד לא ענה, והצעה לסגור בלעדיהם',
    },
    required: ['slot', 'close_note'],
    sample: {
      slot: 'יום שלישי 20:00', yes: '3', total: '5',
      close_note: 'עוד לא ענו: @+972501234567 @+972521234567\nרוצים לסגור בלי מי שלא ענה? תכתבו לי ״סגור״ 👍',
    },
    text: 'יש כיוון: *{{slot}}* — {{yes}} מתוך {{total}} בפנים.\n{{close_note}}',
  },
  // The end of the base line (owner, 2026-09-26): who has not answered, and
  // that the room may close without them. A coordination in a room closes on
  // its own only on a yes from everybody in it, so this is the sentence that
  // tells them the other way. Two keys because with nobody silent — the rest
  // said no to this time — there is nobody to name.
  {
    key: 'group_coord_unanswered', audience: 'group', label: 'תיאום — מי עוד לא ענה, ולסגור בלעדיהם',
    help: 'בסוף שורת ״יש כיוון״, כשיש בקבוצה מי שעוד לא ענה על הזמן הזה. מתייגת אותם (מי שאי אפשר לתייג נספר כ״ועוד N״) ומציעה לסגור בלעדיהם.',
    vars: { who: 'התיוגים של מי שעוד לא ענה' }, required: ['who'],
    sample: { who: '@+972501234567 @+972521234567' },
    text: 'עוד לא ענו: {{who}}\nרוצים לסגור בלי מי שלא ענה? תכתבו לי ״סגור״ 👍',
  },
  {
    key: 'group_coord_close_hint', audience: 'group', label: 'תיאום — אפשר לסגור על הזמן הזה',
    help: 'בסוף שורת ״יש כיוון״, כשכולם ענו אבל לא כולם אמרו כן לזמן הזה. מציעה לסגור עליו.',
    vars: {}, required: [],
    sample: {},
    text: 'רוצים לסגור על זה? תכתבו לי ״סגור״ 👍',
  },
  ...
  },
  {
    ...
    sample: {
      was: 'שבת 16:00',
      lead: 'יש כיוון: *שבת 17:00* — 2 מתוך 3 בפנים.\nעוד לא ענו: @+972501234567\nרוצים לסגור בלי מי שלא ענה? תכתבו לי ״סגור״ 👍',
    },
  ...
  // its author's words with their city beside it, and `{{zones}}` is empty.
  {
    ...
    required: ['title', 'total'],
    sample: {
      title: 'שיחת וידאו', total: '4', cities: 'ישראל, ניו יורק וסידני',
      outside_note: '@+972501234567 עוד לא כתבת לי בפרטי — ״היי״ שם ואצרף אותך לתיאום ☺️',
    },
  ...
  },
  {
    ...
    vars: {
      ...
      yes: 'כמה אמרו לו כן', total: 'כמה אנשים בקבוצה',
      close_note: 'מי עוד לא ענה, והצעה לסגור בלעדיהם',
    },
    required: ['day', 'close_note'],
    sample: {
      day: 'יום שבת 26.9', zones: '20:00 ישראל\n13:00 ניו יורק\n03:00 סידני (יום ראשון 27.9)',
      yes: '2', total: '4',
      close_note: 'עוד לא ענו: @+972501234567\nרוצים לסגור בלי מי שלא ענה? תכתבו לי ״סגור״ 👍',
    },
    text: 'יש כיוון: *{{day}}* — {{yes}} מתוך {{total}} בפנים.\n{{zones}}\n{{close_note}}',
  },
  {
