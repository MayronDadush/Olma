...
const RULES = [
  ['health', [
    ...
    'ריצות', 'לרוץ', 'שחייה', 'לשחות', 'פאדל', 'טניס', 'כדורסל',
    'כדורגל', 'פילאטיס', 'ספורט', 'כושר', 'לשתות מים',
    'doctor', 'dentist', 'clinic', 'hospital', 'pharmacy', 'prescription',
    'medicine', 'meds', 'vaccine', 'therapy', 'physio', 'checkup', 'check-up',
    'blood test', 'gym', 'workout', 'health', 'running', 'swim', 'padel',
    'tennis', 'pilates', 'sport',
  ]],
  ['family', [
  ...
  ['work', [
    ...
    'פרומפט', 'דאשבורד', 'אינטגרצי', 'סטארטאפ', 'לקוחות', 'ספק',
    'shift', 'work', 'client', 'invoice', 'presentation', 'deadline',
    'standup', 'stand-up', 'sprint', 'interview', 'resume', 'office',
    'manager', 'boss', 'project', 'prompt', 'dashboard', 'mcp', 'api',
    'deploy', 'integration', 'demo', 'roadmap', 'backlog',
  ]],
  ['money', [
    ...
    'חיסכון', 'כספים', 'כסף',
    'השקע', 'פנסיו', 'מסלקה', 'מניות', 'קרן השתלמות', 'קרן הפנסיה',
    'rent', 'mortgage', 'loan', 'bank', 'bill', 'bills', 'payment',
    'insurance', 'tax', 'taxes', 'salary', 'budget', 'credit card',
    'pension', 'savings', 'money', 'invest', 'stocks', 'portfolio',
  ]],
  ['errands', [
    ...
    'טיסה', 'טיסות', 'מלון', 'בוקינג', 'מסאז', 'צ׳ק אין',
    ...
    'flight', 'hotel', 'booking', 'spa', 'massage',
  ]],
  ['home', [
    ...
    'מזגן', 'מעבר דירה', 'לעבור דירה', 'דוד שמש', 'בוילר',
