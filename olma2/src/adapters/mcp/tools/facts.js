...
module.exports = [
  ...
  tool('remember_fact', 'Store a durable fact about this person (still true in a month). THIRD PERSON, from your side ("מאיה היא אשתו", never "אשתי") — first person is refused. NOT a task (add_task), NOT a phone number or who-knows-whom (connections), NOT how they like you to work (remember_preference), NOT Olma state the card shows. A constraint about ONE meeting is record_meeting_constraint; a standing availability rule is remember_preference key availability. expires_at is REQUIRED when the fact names a date or a moving day ("היום", "מחר", "29.8").',
