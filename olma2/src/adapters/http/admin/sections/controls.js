...
const FLAG_SPECS = [
  ...
  { key: 'digest_without_model_phones', label: 'סיכום יומי בלי מודל (טקסט) — למי', type: 'text',
    help: 'ריק = לאף אחד; "all" = לכולם; או מספרים ב-E.164 מופרדים בפסיק. מי שברשימה מקבל את הסיכום כטקסט מצויר, בלי קריאה למודל. בוקר שיש בו עדכונים שחיכו בתור (או הודעה נוספת שמתמזגת) עדיין עובר דרך המודל. הניסוחים סביב הרשימה — ב"ניסוחים".' },
  { key: 'digest_card_without_model_phones', label: 'סיכום יומי בלי מודל (תמונה) — למי', type: 'text',
    help: 'אותו דבר, לבקרים שבהם הסיכום נשלח כתמונה. ריק = הבקרים האלה עוברים דרך המודל כמו קודם. לפתוח קודם למספר אחד, לוודא שהתמונה הגיעה לטלפון, ורק אז "all".' },
