...
const FLAG_SPECS = [
  ...
  { key: 'group_invite_unconnected', label: 'הודעה בפרטי לחבר קבוצה שלא כתב לעולמה', type: 'bool',
    help: 'כשפתוח — כשנפתח תיאום בקבוצה, עולמה מצרפת אליו גם חברים שיש להם חשבון אצלה אבל מעולם לא כתבו לה, ושולחת להם הזמנה בפרטי. שים לב לשני דברים לפני שפותחים: (1) חבר שאין לו בכלל שורת משתמש לא נגיש דרך זה — משתתפי תיאום והתפוצה מבוססים על מזהה משתמש, אז אין למי לשלוח; ב-22.9 זה היה נכון לגבי כל החברים שלא כתבו בכל הקבוצות החיות, כלומר פתיחה כאן לא הייתה מגיעה לאף אחד. (2) מי שזה כן יגיע אליו מעולם לא שמע מעולמה, אז ההזמנה הזו תהיה המשפט הראשון שהיא אומרת לו — על תיאום של מישהו אחר.' },
