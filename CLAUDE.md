...
- **…and the zone question in a room on several clocks is its fourth (`room_zone_asked_at`, migration 090)** — only for an unconfirmed zone, riding the room invite, stamped after the send confirms
